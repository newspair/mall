# Generated by Django 2.0.4 on 2019-05-09 13:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now_add=True)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('cate_id', models.ForeignKey(on_delete='CASCADE', related_name='cate_id', to='background.Category')),
                ('coupon_id', models.ForeignKey(on_delete='CASCADE', related_name='coup_id', to='background.Coupon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now_add=True)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('discourse_detail_id', models.ForeignKey(on_delete='CASCADE', related_name='discourse_detail_id', to='background.Discourse_detail')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now_add=True)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('coupon_id', models.ForeignKey(on_delete='CASCADE', related_name='cou_id', to='background.Coupon')),
                ('goods_id', models.ForeignKey(on_delete='CASCADE', related_name='goods_id', to='background.Goods')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_id', models.ForeignKey(on_delete='CASCADE', related_name='t_id', to='background.Goods_type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now_add=True)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('category_id', models.ForeignKey(on_delete='CASCADE', related_name='c_id', to='background.Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now_add=True)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('Permission_id', models.ManyToManyField(related_name='Permission_id', to='background.Permission')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now_add=True)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('brand_id', models.ForeignKey(on_delete='CASCADE', related_name='brand_id', to='background.Brand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete='CASCADE', related_name='u_id', to='background.Users')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='user_concern_brand',
            name='user_id',
            field=models.ForeignKey(on_delete='CASCADE', related_name='user_brand_id', to='background.Users'),
        ),
        migrations.AddField(
            model_name='role_permission',
            name='role_id',
            field=models.ManyToManyField(related_name='ro_id', to='background.Roles'),
        ),
        migrations.AddField(
            model_name='like_category',
            name='user_id',
            field=models.ForeignKey(on_delete='CASCADE', related_name='yonghu_id', to='background.Users'),
        ),
        migrations.AddField(
            model_name='goods_attribute_value',
            name='attribute_id',
            field=models.ForeignKey(on_delete='CASCADE', related_name='attribute_id', to='background.Goods_type_attribute'),
        ),
        migrations.AddField(
            model_name='goods_attribute_value',
            name='goods_id',
            field=models.ForeignKey(on_delete='CASCADE', related_name='g_id', to='background.Goods'),
        ),
        migrations.AddField(
            model_name='discourse_label',
            name='label_id',
            field=models.ForeignKey(on_delete='CASCADE', related_name='label_id', to='background.Label'),
        ),
        migrations.AddField(
            model_name='discourse_collect',
            name='discourse_id',
            field=models.ForeignKey(on_delete='CASCADE', related_name='discourse_id', to='background.Discourse_detail'),
        ),
        migrations.AddField(
            model_name='discourse_collect',
            name='user_id',
            field=models.ForeignKey(on_delete='CASCADE', related_name='us_id', to='background.Users'),
        ),
        migrations.AddField(
            model_name='comment_zan',
            name='discourse_comment_id',
            field=models.ForeignKey(on_delete='CASCADE', related_name='dc_id', to='background.Discourse_comment'),
        ),
        migrations.AddField(
            model_name='comment_zan',
            name='user_id',
            field=models.ForeignKey(on_delete='CASCADE', related_name='user_id', to='background.Users'),
        ),
        migrations.AddField(
            model_name='cate_attribute',
            name='cate_id',
            field=models.ForeignKey(on_delete='CASCADE', related_name='ca_id', to='background.Category'),
        ),
        migrations.AddField(
            model_name='cate_attribute',
            name='goods_type_attribute_id',
            field=models.ForeignKey(on_delete='CASCADE', related_name='goods_type_attribute_id', to='background.Goods_type_attribute'),
        ),
        migrations.AddField(
            model_name='admin_roles',
            name='admin_id',
            field=models.ManyToManyField(related_name='admin_id', to='background.Admins'),
        ),
        migrations.AddField(
            model_name='admin_roles',
            name='role_id',
            field=models.ManyToManyField(related_name='r_id', to='background.Roles'),
        ),
    ]
